...
export type InvariantDetailDtoSeverity = typeof InvariantDetailDtoSeverity[keyof typeof InvariantDetailDtoSeverity];


export const InvariantDetailDtoSeverity = {
  critical: 'critical',
  warning: 'warning',
} as const;
