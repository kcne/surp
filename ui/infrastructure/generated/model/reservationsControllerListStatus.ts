...
export type ReservationsControllerListStatus = typeof ReservationsControllerListStatus[keyof typeof ReservationsControllerListStatus];


export const ReservationsControllerListStatus = {
  ACTIVE: 'ACTIVE',
  CANCELLED: 'CANCELLED',
} as const;
