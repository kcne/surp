...
export type TicketsControllerListCategory = typeof TicketsControllerListCategory[keyof typeof TicketsControllerListCategory];


export const TicketsControllerListCategory = {
  BUG: 'BUG',
  IDEA: 'IDEA',
  FEATURE: 'FEATURE',
  QUESTION: 'QUESTION',
