...
export type LinesControllerListDirection = typeof LinesControllerListDirection[keyof typeof LinesControllerListDirection];


export const LinesControllerListDirection = {
  OUTBOUND: 'OUTBOUND',
  RETURN: 'RETURN',
} as const;
