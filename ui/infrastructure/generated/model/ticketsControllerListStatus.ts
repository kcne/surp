...
export type TicketsControllerListStatus = typeof TicketsControllerListStatus[keyof typeof TicketsControllerListStatus];


export const TicketsControllerListStatus = {
  OPEN: 'OPEN',
