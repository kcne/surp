...
export type LineResponseDtoDirectionMode = typeof LineResponseDtoDirectionMode[keyof typeof LineResponseDtoDirectionMode];


export const LineResponseDtoDirectionMode = {
  SINGLE: 'SINGLE',
  BOTH: 'BOTH',
} as const;
