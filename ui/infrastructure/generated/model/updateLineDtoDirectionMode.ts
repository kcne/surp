...
export type UpdateLineDtoDirectionMode = typeof UpdateLineDtoDirectionMode[keyof typeof UpdateLineDtoDirectionMode];


export const UpdateLineDtoDirectionMode = {
  SINGLE: 'SINGLE',
  BOTH: 'BOTH',
} as const;
