...
export type RideInstanceResponseDtoSource = typeof RideInstanceResponseDtoSource[keyof typeof RideInstanceResponseDtoSource];


export const RideInstanceResponseDtoSource = {
  BASE: 'BASE',
