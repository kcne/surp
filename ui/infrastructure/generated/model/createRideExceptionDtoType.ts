...
export type CreateRideExceptionDtoType = typeof CreateRideExceptionDtoType[keyof typeof CreateRideExceptionDtoType];


export const CreateRideExceptionDtoType = {
  SKIP: 'SKIP',
