...
export type CreateLineDtoDirectionMode = typeof CreateLineDtoDirectionMode[keyof typeof CreateLineDtoDirectionMode];


export const CreateLineDtoDirectionMode = {
  SINGLE: 'SINGLE',
  BOTH: 'BOTH',
} as const;
