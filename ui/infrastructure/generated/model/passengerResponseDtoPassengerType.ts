...
export type PassengerResponseDtoPassengerType = typeof PassengerResponseDtoPassengerType[keyof typeof PassengerResponseDtoPassengerType];


export const PassengerResponseDtoPassengerType = {
  ADULT: 'ADULT',
  CHILD: 'CHILD',
  STUDENT: 'STUDENT',
  SENIOR: 'SENIOR',
