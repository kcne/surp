...
export type RideInstanceResponseDtoStatus = typeof RideInstanceResponseDtoStatus[keyof typeof RideInstanceResponseDtoStatus];


export const RideInstanceResponseDtoStatus = {
  DRAFT: 'DRAFT',
  ACTIVE: 'ACTIVE',
  INACTIVE: 'INACTIVE',
} as const;
