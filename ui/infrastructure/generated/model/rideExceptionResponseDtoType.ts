...
export type RideExceptionResponseDtoType = typeof RideExceptionResponseDtoType[keyof typeof RideExceptionResponseDtoType];


export const RideExceptionResponseDtoType = {
  SKIP: 'SKIP',
