...
export type DomainAuditEventResponseDtoAction = typeof DomainAuditEventResponseDtoAction[keyof typeof DomainAuditEventResponseDtoAction];


export const DomainAuditEventResponseDtoAction = {
  create: 'create',
  update: 'update',
  delete: 'delete',
} as const;
