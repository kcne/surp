...
export type StorefrontAdminResponseDtoStatus = typeof StorefrontAdminResponseDtoStatus[keyof typeof StorefrontAdminResponseDtoStatus];


export const StorefrontAdminResponseDtoStatus = {
  DRAFT: 'DRAFT',
  PUBLISHED: 'PUBLISHED',
} as const;
