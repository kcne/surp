...
export type CreatePassengerDtoPassengerType = typeof CreatePassengerDtoPassengerType[keyof typeof CreatePassengerDtoPassengerType];


export const CreatePassengerDtoPassengerType = {
  ADULT: 'ADULT',
  CHILD: 'CHILD',
  STUDENT: 'STUDENT',
  SENIOR: 'SENIOR',
