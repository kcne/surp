...
export type RideInstanceResponseDtoRideType = typeof RideInstanceResponseDtoRideType[keyof typeof RideInstanceResponseDtoRideType];


export const RideInstanceResponseDtoRideType = {
  RECURRING: 'RECURRING',
  ONE_TIME: 'ONE_TIME',
} as const;
