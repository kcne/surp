...
export type AuditItemResponseDtoAction = typeof AuditItemResponseDtoAction[keyof typeof AuditItemResponseDtoAction];


export const AuditItemResponseDtoAction = {
  CREATED: 'CREATED',
  UPDATED: 'UPDATED',
} as const;
