...
export type PlatformLeadsControllerListStatus = typeof PlatformLeadsControllerListStatus[keyof typeof PlatformLeadsControllerListStatus];


export const PlatformLeadsControllerListStatus = {
  NEW: 'NEW',
  CONTACTED: 'CONTACTED',
  QUALIFIED: 'QUALIFIED',
  FOLLOW_UP: 'FOLLOW_UP',
