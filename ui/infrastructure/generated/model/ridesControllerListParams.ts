 ...
 */
import type { RidesControllerListStatus } from './ridesControllerListStatus';
import type { RidesControllerListType } from './ridesControllerListType';

export type RidesControllerListParams = {
page?: number;
pageSize?: number;
type?: RidesControllerListType;
status?: RidesControllerListStatus;
search?: string;
};
