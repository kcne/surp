...
export type ReportingControllerGetAuditEntity = typeof ReportingControllerGetAuditEntity[keyof typeof ReportingControllerGetAuditEntity];


export const ReportingControllerGetAuditEntity = {
  USERS: 'USERS',
  STATIONS: 'STATIONS',
  LINES: 'LINES',
