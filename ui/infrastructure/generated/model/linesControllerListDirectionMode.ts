...
export type LinesControllerListDirectionMode = typeof LinesControllerListDirectionMode[keyof typeof LinesControllerListDirectionMode];


export const LinesControllerListDirectionMode = {
  SINGLE: 'SINGLE',
  BOTH: 'BOTH',
} as const;
