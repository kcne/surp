...
export type UpdatePlatformLeadDtoStatus = typeof UpdatePlatformLeadDtoStatus[keyof typeof UpdatePlatformLeadDtoStatus];


export const UpdatePlatformLeadDtoStatus = {
  NEW: 'NEW',
  CONTACTED: 'CONTACTED',
  QUALIFIED: 'QUALIFIED',
  FOLLOW_UP: 'FOLLOW_UP',
