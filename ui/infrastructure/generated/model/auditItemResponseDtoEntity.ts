...
export type AuditItemResponseDtoEntity = typeof AuditItemResponseDtoEntity[keyof typeof AuditItemResponseDtoEntity];


export const AuditItemResponseDtoEntity = {
  USERS: 'USERS',
  STATIONS: 'STATIONS',
  LINES: 'LINES',
