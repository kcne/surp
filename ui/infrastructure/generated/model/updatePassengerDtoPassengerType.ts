...
export type UpdatePassengerDtoPassengerType = typeof UpdatePassengerDtoPassengerType[keyof typeof UpdatePassengerDtoPassengerType];


export const UpdatePassengerDtoPassengerType = {
  ADULT: 'ADULT',
  CHILD: 'CHILD',
  STUDENT: 'STUDENT',
  SENIOR: 'SENIOR',
