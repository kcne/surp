        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">Upravljajte autobuskim linijama u sistemu</p>
            </div>
          ...
          {loading && lines.length === 0 ? (
            ...
            <div className="flex flex-col items-center justify-center rounded-lg border border-dashed p-12">
              ...
              <Button onClick={() => linesQuery.refetch()}>Pokusaj ponovo</Button>
            </div>
          ) : lines.length === 0 ? (
            <div className="flex flex-col items-center justify-center rounded-lg border border-dashed p-12">
              <Route className="mb-3 h-10 w-10 text-muted-foreground" />
              <p className="text-lg font-medium text-muted-foreground">Nema linija</p>
              <p className="mb-4 text-sm text-muted-foreground">
